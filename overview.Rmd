...
Simply go to [https://github.com/paciorek/nimble-dlab-2016](https://github.com/paciorek/nimble-dlab-2016) and click on the 'Download ZIP' button in the right side of the window or simply click [here](https://github.com/paciorek/nimble-dlab-2016/archive/master.zip).
...
- "Project Directory Name": nimble-dlab-2016 (or something else of your choosing)
...
- `cd /directory/where/you/put/the/repository/nimble-dlab-2016`
- `git pull`
